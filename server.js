...
function getSystemPrompt(deal, repName, dealsLeft, totalCount) {
    ...
    // 3. HISTORY EXTRACTION [FIXED: Uses risk_summary]
...
### COMPLETION PROTOCOL
    ...
    2. **TRIGGER TOOL:** Call 'save_deal_data'.
       - **DATA EXTRACTION RULES:**
         - Extract **Champion Name** into 'champion_name'.
         - Extract **Economic Buyer Name** into 'eb_name'.
       ...
       - **TIP RULES:** If Score < 3, write specific advice in the 'tip' field.
