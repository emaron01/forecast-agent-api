...
export function PartnersExecutiveAiTakeawayClient(props: { quotaPeriodId: string; payload: any }) {
    ...
    <section className="rounded-xl border border-[color:var(--sf-border)] bg-[color:var(--sf-surface)] p-4 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="mt-3 grid gap-3">
          {summary ? (
            <div className="rounded-lg border border-[color:var(--sf-border)] bg-[color:var(--sf-surface-alt)] p-3 text-sm text-[color:var(--sf-text-primary)]">
