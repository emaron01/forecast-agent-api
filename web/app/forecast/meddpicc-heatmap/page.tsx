...
import { MeddpiccHeatmapClient } from "./uiClient";

export const runtime = "nodejs";

export default async function MeddpiccHeatmapPage({
  searchParams,
}: {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--sf-background)]">
      ...
      <main className="mx-auto max-w-6xl p-6">
        <QuarterSalesForecastSummary orgId={ctx.user.org_id} user={ctx.user} currentPath="/forecast/meddpicc-heatmap" searchParams={searchParams} />
        <MeddpiccHeatmapClient
