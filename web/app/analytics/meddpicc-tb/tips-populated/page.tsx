...
import { MeddpiccTipsPopulatedClient } from "./uiClient";

export const runtime = "nodejs";

export default async function MeddpiccTipsPopulatedPage() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--sf-background)]">
      ...
      <main className="mx-auto max-w-6xl p-6">
        <MeddpiccTipsPopulatedClient quotaPeriods={quotaPeriods} defaultQuotaPeriodId={defaultQuotaPeriodId} />
      </main>
    </div>
  );
}
