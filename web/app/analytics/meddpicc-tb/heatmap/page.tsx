...
import { MeddpiccHeatmapClient } from "../../../forecast/meddpicc-heatmap/uiClient";

export const runtime = "nodejs";

export default async function MeddpiccHeatmapAnalyticsPage() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--sf-background)]">
      ...
      <main className="mx-auto max-w-6xl p-6">
        <MeddpiccHeatmapClient repFilterLocked={false} quotaPeriods={quotaPeriods} defaultQuotaPeriodId={defaultQuotaPeriodId} />
      </main>
    </div>
  );
}
