...
} from "../admin/actions/channelAlignment";
...
async function saveChannelAlignmentAction(formData: FormData) {
  ...
  revalidatePath("/channel-alignment");
  ...
  return (
    <main className="min-h-screen bg-[color:var(--sf-background)]">
      ...
      <div className="mx-auto max-w-7xl px-6 py-6">
        <div className="mb-6">
          <h1 className="text-xl font-semibold tracking-tight text-[color:var(--sf-text-primary)]">Channel Territory Alignment</h1>
          <p className="mt-1 text-sm text-[color:var(--sf-text-secondary)]">
            Assign channel team members to sales territories. Channel executives and directors only see their direct reports.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {channelUsers.length === 0 ? (
            <div className="rounded-xl border border-[color:var(--sf-border)] bg-[color:var(--sf-surface)] p-6 text-sm text-[color:var(--sf-text-secondary)]">
              No channel direct reports available for alignment.
            </div>
          ) : null}
        </div>
      </div>
