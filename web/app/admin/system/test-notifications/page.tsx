...
export default async function TestNotificationsPage() {
  ...
  return (
    <main className="grid gap-4">
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-slate-900">Trigger test notifications</h1>
        <p className="mt-1 text-sm text-slate-600">Stub (master only).</p>
      </div>
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <p className="text-sm text-slate-700">No notifications implemented yet.</p>
      </div>
      <div>
