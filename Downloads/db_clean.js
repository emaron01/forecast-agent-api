// db.js (ES module)
// Safe merge updates (no destructive overwrites). Allows 0 scores; blocks empty-string overwrites.
// Includes MEDDPICC+TB (adds budget_* fields).
  ...
  try {
    ...
    const updateQuery = `
      ...
      SET
        ...
        risk_summary = $35, next_steps = $36, rep_comments = $37,
        ai_forecast = $38,
        run_count = $39,
        updated_at = $40
      WHERE id = $41
    ...
    const values = [
      ...
      merged.budget_score, merged.budget_summary, merged.budget_tip,
